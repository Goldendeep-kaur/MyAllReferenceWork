...
public class BooksPojo {
	...
	public BooksPojo(int bookId, int bookIsbn, String bookName, String bookPublisher, int bookQuantity,
			String bookImgUrl) {
		super();
		this.bookId = bookId;
	...
	public String toString() {
		return "BooksPojo [bookId=" + bookId + ", bookIsbn=" + bookIsbn + ", bookName=" + bookName + ", bookPublisher="
