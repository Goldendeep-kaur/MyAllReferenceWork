...
public class UserPojoo {
	...
	public UserPojoo(int userId, String userFName, String userLName, String userName, String password,
			String userType) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "UserPojoo [userId=" + userId + ", userFName=" + userFName + ", userLName=" + userLName + ", userName="
